...
Los moldes pueden ser de distintos materiales (como silicona, yeso, metal, o plástico) y sirven para dar forma a materiales como el yeso, cera, metal fundido, resinas, etc.
Para la creación de los moldes se pueden usar diversas técnicas.
Una de estas es realizar nuestro molde en un programa de diseño como Fusion 360, AutoCAD, Tinkercad, u otro. Luego de diseñado se puede crear el molde con impresión 3D, corte laser, Reuter CNC u otra herramienta que nos permita llevar nuestro proyecto a la realidad. La herramienta a utilizar va a depender de las características de nuestro molde, algunas de las herramientas que se suelen utilizar son impresión en 3D o corte laser.
...
También podemos crear moldes a partir de piezas ya existentes para clonar dicho objeto.
En este caso se toma la pieza y se elige con que material se va a realizar nuestro molde que este depende también del tipo de material que va a ser nuestra pieza final.
Luego de esto se toma la pieza se coloca en un recipiente o marco dejando espacio para que el material del molde pueda cubrirlo por completo. El material vertido en forma líquida va ir tomando la forma del objeto y al solidificarse quedara con la forma exacta de dicho objeto.
