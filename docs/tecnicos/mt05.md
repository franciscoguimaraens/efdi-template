...
Al igual que la impresión en 3D también se fueron desarrollando softwares y hadwares específicos para este tipo de tecnología, como es el caso del escaneo en 3D.
El escaneo 3D es una tecnología que permite capturar la forma, textura y detalles de un objeto o superficie en un espacio físico y convertirlo en un modelo tridimensional digital. Esto se logra utilizando dispositivos llamados escáneres 3D, que emplean métodos como luz estructurada, láser, fotogrametría o sensores de profundidad.
También estos trabajos se pueden realizar con dispositivos más económicos como lo son los teléfonos celulares, es una alternativa accesible y práctica gracias a los avances en cámaras y sensores en los dispositivos móviles.
Esto claramente trae un gran avance ya que se pueden hacer replicas exactas de algunos objetos sin tener que moverlos de su lugar o en objetos que son muy difíciles de tomarles medidas.
