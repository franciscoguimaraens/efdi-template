...
Me permitió realizar construcciones en 2D para luego extruirlas y ensamblarlas y verificar antes de traerlos a la realidad para así ver cumplían con lo requerido.
...
Dentro de la caja interna del desalinizador, está instalada una boba de agua que tiene como función sacar el agua del desalinizador para realizar una limpieza cuando se desee. Esta bomba es accionada por un pulsador manual que se encuentra fuera de la caja estanca.
...
6- Al poder ya colocar la caja estanca y dimensionar donde iban a ir instalados los sensores, continue realizando la instalación del Arduino Uno. Este lo instale a un costado, precisamente en el lateral que da al punto cardinal Este ya que es el que recibirá los rayos del sol más tenues. (Figura 6).
